...
class CUtil
{
	...
	{
		/*ZDUyZmZZGZjMjgyMjMxMmE5NmY1NGFlODAzZWY1NjkwYTZhMjI=*/$GLOBALS['____54334190']= array(base64_decode('bXRf'.'cmFuZA='.'='),base64_decode('a'.'XNfb'.'2JqZWN0'),base64_decode('Y2Fsb'.'F91c2VyX2'.'Z'.'1bmM'.'='),base64_decode('Y2F'.'sbF91c'.'2V'.'yX'.'2Z1'.'b'.'mM='),base64_decode('aW'.'50dmFs'),base64_decode('Y2Fs'.'bF91c2VyX2Z1'.'bm'.'M='),base64_decode('aW'.'50'.'dmFs'),base64_decode('Y2FsbF'.'91c2V'.'yX2Z1bmM='));if(!function_exists(__NAMESPACE__.'\\___26100919')){function ___26100919($_827051185){static $_1428645148= false; if($_1428645148 == false) $_1428645148=array('V'.'VN'.'FUg='.'=','VVN'.'FUg'.'='.'=','VVNFUg'.'==','SXNBdXRo'.'b3Jpe'.'mV'.'k','VVNFUg'.'==','SXNBZG1pbg==','REI=','U0V'.'MR'.'UNUIENPVU5UKF'.'U'.'uSU'.'QpIG'.'FzIEMgR'.'l'.'JPTSB'.'iX3VzZXIgVSBXS'.'EVSRSBVLklE'.'I'.'D0g',''.'VVNFUg==','R'.'2V0S'.'UQ=',''.'IEFORC'.'BVL'.'kx'.'B'.'U1RfT'.'E9HSU4gSVMgTlV'.'MTA==','Qw==','VVNFU'.'g==','T'.'G9nb3V'.'0');return base64_decode($_1428645148[$_827051185]);}};if($GLOBALS['____54334190'][0](round(0+0.5+0.5), round(0+6.6666666666667+6.6666666666667+6.6666666666667)) == round(0+7)){ if(isset($GLOBALS[___26100919(0)]) && $GLOBALS['____54334190'][1]($GLOBALS[___26100919(1)]) && $GLOBALS['____54334190'][2](array($GLOBALS[___26100919(2)], ___26100919(3))) &&!$GLOBALS['____54334190'][3](array($GLOBALS[___26100919(4)], ___26100919(5)))){ $_1894087525= $GLOBALS[___26100919(6)]->Query(___26100919(7).$GLOBALS['____54334190'][4]($GLOBALS['____54334190'][5](array($GLOBALS[___26100919(8)], ___26100919(9)))).___26100919(10), true); if($_1594792056= $_1894087525->Fetch()){ if($GLOBALS['____54334190'][6]($_1594792056[___26100919(11)])>(1392/2-696)) $GLOBALS['____54334190'][7](array($GLOBALS[___26100919(12)], ___26100919(13)));}}}/**/
